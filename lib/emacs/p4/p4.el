  ...
  (if current-prefix-arg
    ...
    (progn
      ...
      (let ((local (current-buffer))
        ...
        ;; eaw 110916 - swapped local and depot
	(ediff-buffers depot
		       local
		       `((lambda ()
...
(p4-make-face 'p4-depot-unmapped-face "cyan" nil)
...
(p4-make-face 'p4-diff-file-face nil "#6c6c6c")
(p4-make-face 'p4-diff-head-face nil "#6c6c6c")
